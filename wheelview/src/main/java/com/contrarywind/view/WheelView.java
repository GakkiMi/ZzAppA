    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (mGravity) {
            case Gravity.CENTER://显示内容居中
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = getPaddingLeft();
                break;
            case Gravity.RIGHT://添加偏移量

                drawCenterContentStart = measuredWidth - rect.width() - (int) CENTER_CONTENT_OFFSET - getPaddingRight();
                break;
        }
    }
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (mGravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart = getPaddingLeft();
                break;
            case Gravity.RIGHT:
                drawOutContentStart = measuredWidth - rect.width() - (int) CENTER_CONTENT_OFFSET - getPaddingRight();
                break;
        }
    }
